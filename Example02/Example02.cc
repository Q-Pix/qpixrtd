...
{  
   ...
   std::string Output_File = "Proton_Output_6000.txt";
   ...
   int N_Events = Event_Lengths.size();

   std::vector<std::vector<double>> RTD_full;
   for (int Event = 0; Event < N_Events; Event++)
   {
      ...
      RTD_full.insert(RTD_full.end(), RTD.begin(), RTD.end());
   }
   ...
   Qpix::Write_Reset_Data( Output_File, Event, RTD_full);
