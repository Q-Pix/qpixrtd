...
//g++ -std=c++11 root_macro.cpp -o root_macro -lroot
...
int main()
{
  ...
  for (size_t idx = 0; idx < number_entries; ++idx)
  {
    ...
    for (int h_idx = 0; h_idx < number_hits_; ++h_idx)
    {
      ...
      //std::cout << start_x << " " << start_y << " " << start_z << " " << start_t << " " << std::endl;
      ...
      double const process_key = hit_process_key_->at(h_idx);
        ...
        if (idx==100)
        {
            std::cout << "start "<< start_x << " " << start_y << " " << start_z << " " << start_t << " " << std::endl;
            std::cout << "end   "<< end_x << " " << end_y << " " << end_z << " " << end_t << " " << std::endl;
            std::cout << "e dep "<<  energy_deposit << " " << std::endl;
